...
- [Static homepage](https://dating-privacy.hestialabs.org/en/) & site specific pages
- [Blog system](https://dating-privacy.hestialabs.org/en/blog/)
- [Contact form](https://dating-privacy.hestialabs.org/en/contact/info/), with Netlify Forms
- [Newsletter sign-up form](https://dating-privacy.hestialabs.org/en/#newsletter), with Netlify Forms
- [Ask for your data form](https://dating-privacy.hestialabs.org/en/act/sar/)
...
1. [WEBSITE](https://dating-privacy.hestialabs.org/): publicly accessible, in english only;
2. [CMS](https://dating-privacy.hestialabs.org/admin/): our content-authoring system (_aka_ [Netlify CMS](https://www.netlifycms.org)) web app, accessible thru invite only.
